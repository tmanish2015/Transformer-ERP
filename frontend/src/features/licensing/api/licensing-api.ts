 ...
 * license-key lookup needed. Returns {valid:false} rather than throwing when the company
 * has no license_customers row yet (e.g. mid-onboarding), so a fresh signup degrades
